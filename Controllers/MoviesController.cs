...
namespace MoviesShop.Controllers
{
    public class MoviesController : Controller
    {
        ...
        // POST: Movies/SearchResults
        public async Task<IActionResult> SearchResults(string SearchTitle)
        {
            return View("Index", await _context.Movies.Where( t => t.Title.Contains(SearchTitle)).ToListAsync());
        }
